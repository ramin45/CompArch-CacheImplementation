...
int main(int argc, char* argv[])
{
    ...
    int L1RR[L1_blocks];
    int L2RR[L2_blocks];
    for( int k =0 ; k<L1arraysize; k++)
        L1RR[k] = 0;
    
    for( int k =0 ; k<L2arraysize; k++)
        L2RR[k] = 0;
    ...
    int tag_L1_i, index_L1_i, tag_L2_i, index_L2_i;
    int L1_cache , L2_cache;    // To determine whether its the L1 cache or L2 cache
    L1_cache='1';
    L2_cache='0';
    int flag1,flag2;
    ifstream traces;
    ...
    if (traces.is_open()&&tracesout.is_open())
    {
        ...
        {   // read mem access file and access Cache
            ...
            long int flag1= int(L1[index_L1_i].to_ulong());
            long int flag2= int(L2[index_L2_i].to_ulong());
                ...
                //
            {
                ...
                else if ( cacheconfig.L1setsize == 1 && cacheconfig.L2setsize !=1)           // L1 is dirct mapped L2 is set associative
                {
                    ...
                    else if( flag1!= tag_L2_i || L1valid[index_L1_i] == '1')
                    {
                        ...
                        if(way_hit == 0)
                        {
                            cout<<"Read in L2 going to Main mem"<<endl;                      // Read miss in L2 output 2
                            L2AcceState = 2;
